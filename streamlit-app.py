...
def load_models():
    ...
    wv_model = tf.keras.models.load_model('models/model3_1test_recall_0.7856')
    adsr_model_durations = tf.keras.models.load_model('models/model3.2_durationstest_mse0.383')
